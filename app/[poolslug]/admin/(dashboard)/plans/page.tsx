...
export default function PlansPage() {
    ...
    const inputCls = "mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500";
    const labelCls = "block text-sm font-medium text-gray-700 dark:text-gray-300";
    const checkCls = "rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:ring-offset-gray-900";
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                {isAdmin && (
                    <button
                        onClick={openCreate}
                        type="button"
                        className="mt-4 sm:mt-0 flex items-center gap-1.5 rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 transition"
                    >
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {loading ? (
                    ...
                    plans.map((plan: any) => (
                        <div
                            key={plan._id}
                            className="relative flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900"
                        >
                            <div>
                            ...
                            {isAdmin && (
                                <div className="mt-5 flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 rounded-md bg-indigo-50 px-3 py-2 text-sm font-semibold text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:text-indigo-400 dark:hover:bg-indigo-900/50 transition"
                                    >
                                        Edit
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 rounded-md bg-white px-3 py-2 text-sm font-semibold text-red-600 ring-1 ring-inset ring-red-300 hover:bg-red-50 dark:bg-gray-800 dark:ring-red-900 dark:hover:bg-gray-700 transition"
                                    >
                    ...
                    <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-gray-900 shadow-2xl flex flex-col max-h-[90vh]">
                        ...
                        <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-3">
                            ...
                            <button
                                type="submit"
                                form="plan-form"
                                className="px-5 py-2 text-sm rounded-md bg-indigo-600 text-white font-semibold hover:bg-indigo-500 transition"
                            >
