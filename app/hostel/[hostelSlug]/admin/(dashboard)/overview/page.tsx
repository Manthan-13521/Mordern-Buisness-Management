                                            ...
                                            <div className="flex flex-col-reverse gap-3 w-full mt-2">
                                                {b.floors.map((_, i) => (
                                                    <div key={i} className="w-full flex justify-around px-1">
                                                        {/* 3 Windows per floor */}
                                                        <div className="w-6 h-8 bg-sky-200 dark:bg-sky-900/60 border-b-4 border-slate-300 rounded-t-sm shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)] group-hover:bg-indigo-500/10 dark:group-hover:bg-indigo-800/40 transition-colors relative"><div className="absolute top-0 right-1 w-1 h-4 bg-white/40 rotate-[20deg] rounded-full"></div></div>
                                                        <div className="w-6 h-8 bg-sky-200 dark:bg-sky-900/60 border-b-4 border-slate-300 rounded-t-sm shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)] group-hover:bg-indigo-500/10 dark:group-hover:bg-indigo-800/40 transition-colors relative"><div className="absolute top-0 right-1 w-1 h-4 bg-white/40 rotate-[20deg] rounded-full"></div></div>
                                                        <div className="w-6 h-8 bg-sky-200 dark:bg-sky-900/60 border-b-4 border-slate-300 rounded-t-sm shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)] group-hover:bg-indigo-500/10 dark:group-hover:bg-indigo-800/40 transition-colors relative"><div className="absolute top-0 right-1 w-1 h-4 bg-white/40 rotate-[20deg] rounded-full"></div></div>
                                                    </div>
                                                ))}
