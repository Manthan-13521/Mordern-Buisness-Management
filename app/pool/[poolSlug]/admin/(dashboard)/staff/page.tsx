...
const ROLE_COLORS: Record<string, string> = {
    ...
    Staff:   "bg-gray-100 text-gray-700 ring-gray-200 dark:bg-white/5 dark:backdrop-blur-md dark:border dark:border-white/10 shadow-sm dark:text-gray-400 dark:ring-gray-700",
};
...
function AddStaffModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-2xl bg-background border border-gray-100 dark:border-gray-800 shadow-2xl p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button type="submit" disabled={saving}
                            className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 border-0 px-4 py-2 text-sm font-medium text-white hover:bg-blue-50 dark:hover:bg-blue-500/100 disabled:opacity-60">
        ...
        <div className="space-y-6">
            ...
            <div className="relative max-w-sm">
                ...
                <input type="text" placeholder="Search name, ID, phone…" value={search} onChange={e => setSearch(e.target.value)}
                    className="block w-full rounded-md border border-gray-300 dark:border-gray-700 py-2 pl-9 pr-3 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 sm:text-sm bg-background shadow-sm dark:text-white" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <table className="min-w-full divide-y divide-gray-300 dark:divide-gray-800">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-background dark:divide-gray-800">
                            {loading ? (
                                ...
                                <tr key={s._id} className={`hover:bg-gray-50 dark:hover:bg-black/50 cursor-pointer transition-colors ${selected?._id === s._id ? "bg-indigo-50 dark:bg-indigo-900/20" : ""}`}
                ...
                {/* Attendance Sidebar */}
                <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-background shadow-sm overflow-y-auto max-h-[80vh]">
                    {selected ? (
                        <>
                            ...
                            {/* Quick Check-in/out */}
                            <div className="px-5 py-3 flex gap-2 border-b border-gray-100 dark:border-gray-800 bg-gray-50 bg-background/50">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="grid grid-cols-7 gap-1">
                                                    ...
                                                    {Array.from({ length: daysInMonth }).map((_, i) => {
                                                        ...
                                                        let bg = "bg-background border border-gray-200 dark:border-white/5 shadow-sm text-gray-400";
                                                        if (!isFuture) {
