        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-neutral-400 mt-1">Manage SaaS business tenants, monitor activity, and control access.</p>
                </div>
                ...
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="bg-neutral-900 border border-neutral-800 rounded-xl pl-10 pr-4 py-2.5 w-full md:w-80 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all"
                    />
                </div>
            </div>
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl overflow-hidden backdrop-blur-sm shadow-xl">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-neutral-800/50 text-neutral-400 text-xs uppercase tracking-wider font-bold border-b border-neutral-800">
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={5} className="px-6 py-20 text-center">
                                        ...
                                        <p className="text-neutral-500 mt-2 text-sm">Loading businesses...</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colSpan={5} className="px-6 py-20 text-center">
                                        ...
                                        <p className="text-neutral-400 font-medium">No businesses found</p>
                                        <p className="text-neutral-500 text-sm mt-1">Try adjusting your search criteria</p>
                                    </td>
                                </tr>
                            ) : filteredBusinesses.map((business) => (
                                <tr key={business._id} className="hover:bg-white/[0.02] transition-colors group">
                                    <td className="px-6 py-5">
                                        <div className="flex items-center gap-3">
                                            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center border border-white/5 font-bold text-blue-400">
                                                {business.name.charAt(0)}
                                            </div>
                                            <div>
                                                <div className="font-bold text-neutral-100">{business.name}</div>
                                                <div className="text-xs text-neutral-500 font-mono">/{business.slug}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        <div className="flex flex-col gap-1">
                                            <div className="flex items-center gap-2 text-sm text-neutral-300">
                                                <UserCircle className="h-3.5 w-3.5 text-neutral-500" />
                                                {business.adminEmail}
                                            </div>
                                            <div className="text-xs text-neutral-500">{business.phone || "No phone provided"}</div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        {business.isActive ? (
                                    ...
                                    <td className="px-6 py-5 text-right">
                                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button 
                                                ...
                                                className="p-2 hover:bg-white/10 rounded-lg text-neutral-400 hover:text-white transition-all shadow-sm"
                                                title="View Details"
                                            >
                                            ...
                                            <button 
                                                ...
                                                className={`p-2 hover:bg-white/10 rounded-lg transition-all shadow-sm ${business.isActive ? "text-orange-400" : "text-emerald-400"}`}
                                            ...
                                            <a 
                                                ...
                                                target="_blank"
                                                className="p-2 hover:bg-white/10 rounded-lg text-blue-400 hover:text-blue-300 transition-all shadow-sm"
            ...
            {selectedBusiness && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                    <div className="bg-neutral-900 border border-neutral-800 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl overflow-y-auto max-h-[90vh]">
                        <div className="bg-gradient-to-br from-blue-600/20 to-indigo-600/20 p-8 border-b border-neutral-800 relative">
                            ...
                            >
                                <XCircle className="h-6 w-6 text-neutral-400 hover:text-white" />
                            </button>
                            ...
                            <p className="text-neutral-400 font-mono text-sm leading-relaxed">/{selectedBusiness.slug}</p>
                        </div>
                        
                        <div className="p-8 space-y-8">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-neutral-800/50 p-6 rounded-2xl border border-white/5">
                                    <p className="text-xs font-bold text-neutral-500 uppercase tracking-widest mb-1">Customers</p>
                                    <p className="text-3xl font-black text-white">{selectedBusiness.stats?.customers || 0}</p>
                                </div>
                                <div className="bg-neutral-800/50 p-6 rounded-2xl border border-white/5">
                                    <p className="text-xs font-bold text-neutral-500 uppercase tracking-widest mb-1">Transactions</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between py-3 border-b border-neutral-800 text-sm">
                                    <span className="text-neutral-500 font-medium">Business ID</span>
                                    <span className="text-neutral-300 font-mono">{selectedBusiness.businessId}</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-neutral-800 text-sm">
                                    <span className="text-neutral-500 font-medium">Admin Email</span>
                                    <span className="text-neutral-300">{selectedBusiness.adminEmail}</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-neutral-800 text-sm">
                                    <span className="text-neutral-500 font-medium">Join Date</span>
                                    <span className="text-neutral-300">{new Date(selectedBusiness.createdAt).toLocaleDateString()}</span>
                                </div>
                                <div className="flex items-center justify-between py-3 border-b border-neutral-800 text-sm">
                                    <span className="text-neutral-500 font-medium">Contact Phone</span>
                                    <span className="text-neutral-300">{selectedBusiness.phone || "N/A"}</span>
                                </div>
                            </div>

                            <button 
                                onClick={() => setSelectedBusiness(null)}
                                className="w-full py-4 text-sm font-bold bg-neutral-800 hover:bg-neutral-700 text-white rounded-2xl transition-all border border-white/5 shadow-inner"
                            >
                                Close View
                            </button>
                        </div>
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in zoom-in-95 duration-200">
                    <div className="bg-neutral-900 border border-red-500/20 rounded-3xl w-full max-w-md p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <ul className="mt-4 space-y-2 text-xs text-neutral-500 font-medium list-disc list-inside">
