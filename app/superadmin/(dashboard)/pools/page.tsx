        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                    ...
                    <p className="text-[#6b7280]">View, monitor, and provision swimming pools across the platform.</p>
                </div>
                <Link href="/subscribe?admin=true" className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 border-0 text-white px-4 py-2 font-bold rounded-xl shadow-lg transition flex items-center gap-2">
                ...
                <div className="bg-[#0b1220] p-4 border-b border-[#1f2937] flex items-center justify-between">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-slate-950/50 border border-[#1f2937] text-white text-sm rounded-lg focus:ring-[#8b5cf6] focus:border-blue-500 block w-full pl-9 p-2 placeholder-gray-500"
                        />
                    </div>
                </div>
                        ...
                        {pools.map((pool: any) => (
                            <tr key={pool._id.toString()} className="border-b border-[#1f2937] hover:bg-[#0b1220] transition-colors">
                                <td className="px-6 py-4 font-medium text-white whitespace-nowrap">
                                    ...
                                    <div className="text-xs text-[#6b7280] font-normal">{pool.poolId}</div>
                                </td>
                                ...
                                <td className="px-6 py-4 text-xs">
                                    <div className="text-[#9ca3af]"><b>Email:</b> {pool.adminEmail}</div>
                                    {pool.adminPhone && (
                                        <div className="text-[#9ca3af] mt-0.5"><b>Phone:</b> {pool.adminPhone}</div>
                                    )}
